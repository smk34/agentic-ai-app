  ...
  return (
     <div className="min-h-screen flex items-center justify-center bg-black px-4">
      <div className="w-full max-w-sm bg-zinc-900 rounded-xl p-8 shadow-lg text-white">
        ...
        <p className="text-sm text-zinc-400 mb-6">Enter your email below to login to your account</p>
        ...
        {/* <div className="mt-4 p-3 bg-zinc-800 rounded-md">
          <p className="text-xs text-zinc-400 text-center">Demo: demo@example.com / password</p>
        </div> */}
      </div>
    </div>
  );
